...
namespace Pong{
	...
	protected:
		virtual void SetToDefaultState() final override{
			...
			ball->SetScale(0.5f);
			ball->AddComponent(new Gadget::RenderComponent(ball->GetGUID(), SID("CubeModel"), SID("WhiteColorMaterial")));
			...
			topWall->AddComponent(new Gadget::RenderComponent(topWall->GetGUID(), SID("CubeModel"), SID("DarkGrayColorMaterial")));
			...
			bottomWall->AddComponent(new Gadget::RenderComponent(bottomWall->GetGUID(), SID("CubeModel"), SID("DarkGrayColorMaterial")));
			...
			leftGoal->AddComponent(new Gadget::RenderComponent(leftGoal->GetGUID(), SID("CubeModel"), SID("DarkGrayColorMaterial")));
			...
			rightGoal->AddComponent(new Gadget::RenderComponent(rightGoal->GetGUID(), SID("CubeModel"), SID("DarkGrayColorMaterial")));
